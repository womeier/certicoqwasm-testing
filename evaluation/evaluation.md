...
| Wasm | (Node.js)      |    40 ms |  116 ms |     77 ms | 21 ms | non-CPS, BAD     | [non-cps-bad-Wasm](https://github.com/womeier/certicoqwasm-testing/tree/master/evaluation/binaries/non-cps-BAD-feb-06-24)
| Wasm | (Node.js)      |    31 ms |  101 ms |     71 ms | 21 ms | non-CPS, PROPER  | [non-cps-proper-Wasm](https://github.com/womeier/certicoqwasm-testing/tree/master/evaluation/binaries/non-cps-PROPER-feb-07-24)
