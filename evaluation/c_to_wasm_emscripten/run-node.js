...
var wasmBinaryFile;
wasmBinaryFile = `${path}/${program}.wasm`;
...
function callMain(args = []) {
  ...
  try {
      ...
      console.log(`Benchmark emscripten ${path}: {{"time_startup": "${time_startup}", "time_main": "${time_main}", "time_pp": "${time_pp}", "program": "${program}"}} ms.`);
