...
((js)=>
      async args=>{
       "use strict";
       let {src: src, generated: generated} = args;
	  function loadRelative(src){
	      const f = `${path}${program}.wasm`;
	   return readFile(f);
       }
       function fetchRelative(src){
        const
         base = globalThis?.document?.currentScript?.src,
         url = base ? new URL(src, base) : src;
        return fetch(url);
       }
	  ...
	  const fs = isNode && fs1; 
       ...
       function wrap_fun(t, f, a){
        try{return new WebAssembly.Function(t, f, a);}catch(e){return f;}
       }
       const
       ...
       let
        bindings =
          {jstag:
           ...
           iter_props:
           (o, f)=>{for(var nm in o) if(o.hasOwnProperty(nm)) f(nm);},
            ...
            while(1){
             let
              {read: read, written: written} =
                encoder.encodeInto(s.slice(start), out_buffer);
             len -= read;
           ...
           f=>
              function(){
               var n = arguments.length, args = new Array(n + 1);
               args[0] = this;
           ...
           suspend_fiber:
           wrap_fun
            ({parameters: ["externref", "funcref", "eqref"],
              results: ["eqref"]},
        ...
        imports =
          Object.assign
           ({Math: math,
             ...
             env: {}},
            generated),
          options = {builtins: ["js-string", "text-decoder", "text-encoder"]};
	  ...
	  const time_startup = stop_startup - start_startup;
       var
        {caml_callback: caml_callback,
          caml_alloc_tm: caml_alloc_tm,
          caml_start_fiber: caml_start_fiber,
          caml_handle_uncaught_exception: caml_handle_uncaught_exception,
          caml_buffer: caml_buffer,
          caml_extract_string: caml_extract_string,
       ...
       if(process && process.on)
        process.on
         ("uncaughtException",
          (err, origin)=>caml_handle_uncaught_exception(err));
 ...
 ({"generated":
   (globalThis=>{
      var
       ...
       jsoo_exports = globalThis?.module?.export || globalThis;
      return {"strings":
